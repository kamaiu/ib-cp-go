...
func (c *Client) Trsrv_Stocks_GET(
...
func (c *Client) Portfolio_Subaccounts_GET() (
	_200 *Account,
	err error,
) {
	_u := bytebufferpool.Get()
...
func (c *Client) Fyi_Disclaimer_Typecode_GET(
...
func (c *Client) Iserver_Marketdata_History_GET(
	// contract id
	conid string,
...
func (c *Client) Portfolio_Accounts_GET() (
	_200 Accounts_List,
	err error,
) {
	_u := bytebufferpool.Get()
...
// for details.
func (c *Client) Iserver_Marketdata_Snapshot_GET(
...
func (c *Client) Iserver_Account_Orders_FaGroup_POST(
...
func (c *Client) Iserver_Reply_Replyid_POST(
